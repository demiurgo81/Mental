...
# Lanzar el gateway de Java
port = launch_gateway(classpath=tabula.environment_info().get('classpath'), die_on_exit=True)
gateway = JavaGateway(gateway_parameters=GatewayParameters(port=port))

# Configurar el logging de Java para suprimir warnings
java_logger = gateway.jvm.org.apache.log4j.Logger
java_level = gateway.jvm.org.apache.log4j.Level
pdfbox_logger = java_logger.getLogger("org.apache.pdfbox")
pdfbox_logger.setLevel(java_level.ERROR)
